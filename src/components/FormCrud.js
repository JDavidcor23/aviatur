...
const FormCrud = ({ setHotels }) => {
  const [img1, setImg1] = useState(
    "https://res.cloudinary.com/dhu6ga6hl/image/upload/v1649743975/b9iv6irmx5479xp3svyx.png"
  );
  ...
  const handleSubmit = (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        getData(url).then((data) => setHotels(data));
      }, 500);

      e.target.reset();
      setImg1("https://res.cloudinary.com/dhu6ga6hl/image/upload/v1649743975/b9iv6irmx5479xp3svyx.png");
  ...
  return (
    <form id="form_crud" onSubmit={handleSubmit}>
      ...
      />
      <img src={img1} alt="hotel_img" className="prev_img" />
      <button
      ...
      <button className="buttons_crud" type="submit" style={{ width: "150px" }}>
        Subir
      </button>
    </form>
  );
